...
public class UiListViewAdapter extends BaseAdapter {
    ...
    public UiListViewAdapter(String color) {
    this.setcolor=color;
    }
    ...
    @Override
    //////////////////////////////////////////////////////////////////////////////////////
    // uirow.xml를 하나의 아이템으로하여 그 아이템들을 아이폰 폴더 구조처럼 배열하는 어댑터
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.mainicon_uirow, parent, false);
        }

        //approw에 있는 뷰들을 하나의 아이템(아이콘+어플명+apk명)으로 만들어줌
        ImageView iconImageView = (ImageView) convertView.findViewById(R.id.ui_icon) ;
        TextView Name = (TextView) convertView.findViewById(R.id.ui_name) ;
        TextView Sub1View = (TextView) convertView.findViewById(R.id.ui_sub1) ;
        TextView Sub2View = (TextView) convertView.findViewById(R.id.ui_sub2) ;
