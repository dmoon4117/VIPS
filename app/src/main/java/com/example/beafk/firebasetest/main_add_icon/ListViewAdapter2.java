...
public class ListViewAdapter2 extends BaseAdapter {
    ...
    public ListViewAdapter2(String color) {this.setcolor=color;}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.mainicon_add_approw2, parent, false);
        }
        ...
        titleTextView.setTextColor(Color.parseColor(setcolor));
    ...
    public void addItem(Drawable icon, String sub1) {
